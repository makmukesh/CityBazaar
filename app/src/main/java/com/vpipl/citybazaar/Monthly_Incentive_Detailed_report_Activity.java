...
public class Monthly_Incentive_Detailed_report_Activity extends AppCompatActivity {

    Activity act = Monthly_Incentive_Detailed_report_Activity.this;
    private String TAG = "Monthly_Incentive_Detailed_report_Activity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            txt_heading.setText("Monthly Incentive Detail Report");
                ...
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            ...
                            response = AppUtils.callWebServiceWithMultiParam(act, postParameters, QueryUtils.methodMonthlyIncentiveDetail, TAG);
...
/*Payout No   From Date   To Date   Left Brought Forward Business   Right Brought Forward Business   Left New Business   Right New Business
Left Total Business   Right Total Business   Power Side Business   Weaker Side Business   Matched Business   BV Matching Bonus
Left Side Carry Forward Business   Right Side Carry Forward Business   Gross Incentive   TDS Amount   Previous Balance   Net Incentive
Closing Balance   Closing Balance Reason   Pay Status   Payment Date   Transaction No.   Remarks*/
        A1.setText("Payout No");
        B1.setText("From Date");
        C1.setText("To Date");
        D1.setText("Left Brought Forward Business");
        E1.setText("Right Brought Forward Business");
        F1.setText("Left New Business");
        G1.setText("Right New Business");
        H1.setText("Left Total Business");
        I1.setText("Right Total Business");
        J1.setText("Power Side Business");
        K1.setText("Weaker Side Business");
        L1.setText("Matched Business");
        M1.setText("BV Matching Bonus");
        N1.setText("Left Side Carry Forward Business");
        O1.setText("Right Side Carry Forward Business");
        P1.setText("Gross Incentive");
        Q1.setText("TDS Amount");
        R1.setText("Previous Balance");
        S1.setText("Net Incentive");
        T1.setText("Closing Balance");
        U1.setText("Closing Balance Reason");
        V1.setText("Pay Status");
        W1.setText("Payment Date");
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            try {
/*Payout No":16,"From Date":"Sep 29 2020 12:01AM","To Date":"Oct  5 2020 12:03AM","Left Brought Forward Business":0.00,
"Right Brought Forward Business":1288000.00,"Left New Business":29000.00,"Right New Business":228000.00,"Left Total Business":276000.00,
"Right Total Business":1763000.00,"Power Side Business":1516000.00,"Weaker Side Business":29000.00,"Matched Business":29000.00,
"BV Matching Bonus":3000.00,"Left Side Carry Forward Business":0.00,"Right Side Carry Forward Business":1487000.00,"Gross Incentive":3000.00,
"TDS Amount":150.00,"Previous Balance":0.00,"Net Incentive":2850.00,"Closing Balance":0.00,"Closing Balance Reason":"","Pay Status":"Unpaid",
"Payment Date":"NA","Transaction No.":"0","Remarks":""*/
                JSONObject jobject = jsonArray.getJSONObject(i);
                int i_1 = jobject.getInt("Payout No");
                final String str2 = jobject.getString("From Date");
                final String str3 = jobject.getString("To Date");
                final String str4 = jobject.getString("Left Brought Forward Business");
                final String str5 = jobject.getString("Right Brought Forward Business");
                final String str6 = jobject.getString("Left New Business");
                final String str7 = jobject.getString("Right New Business");
                final String str8 = jobject.getString("Left Total Business");
                final String str9 = jobject.getString("Right Total Business");
                final String str10 = jobject.getString("Power Side Business");
                final String str11 = jobject.getString("Weaker Side Business");
                final String str12 = jobject.getString("Matched Business");
                final String str13 = jobject.getString("BV Matching Bonus");
                final String str14 = jobject.getString("Left Side Carry Forward Business");
                final String str15 = jobject.getString("Right Side Carry Forward Business");
                final String str16 = jobject.getString("Gross Incentive");
                final String str17 = jobject.getString("TDS Amount");
                final String str18 = jobject.getString("Previous Balance");
                final String str19 = jobject.getString("Net Incentive");
                final String str20 = jobject.getString("Closing Balance");
                final String str21 = jobject.getString("Closing Balance Reason");
                final String str22 = jobject.getString("Pay Status");
...
*//**//*
        ...
        B1.setText("From\nDate");
        C1.setText("To\nDate");
        D1.setText("Left Brought\nForward Business");
        E1.setText("Right Brought\nForward Business");
        F1.setText("Left New\nBusiness");
        G1.setText("Right New\nBusiness");
        H1.setText("Left Total\nBusiness");
        I1.setText("Right Total\nBusiness");
        J1.setText("Power Side\nBusiness");
        L1.setText("Weaker Side\nBusiness");
        M1.setText("Matched\nBusiness");
        N1.setText("BV Matching\nBonus");
        O1.setText("Gross\nIncentive");
        P1.setText("TDS\nAmount");
        Q1.setText("Previous\nBalance");
        R1.setText("Net\nIncentive");
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            try {
                ...
                JSONObject jobject = jsonArray.getJSONObject(i);
*//*Payout No":20200930,"From Date":"Sep 30 2020 12:00AM","To Date":"Oct  1 2020 12:00AM","Left Brought Forward Business":0.00,
"Right Brought Forward Business":1343000.00,"Left New Business":29000.00,"Right New Business":58000.00,"Left Total Business":29000.00,
"Right Total Business":1401000.00,"Power Side Business":1401000.00,"Weaker Side Business":29000.00,"Matched Business":29000.00,
"BV Matching Bonus":3000.00,"Gross Incentive":3000.00,"TDS Amount":150.00,"Previous Balance":0.00,"Net Incentive":2850.00,
"Closing Balance":0.00,"Closing Balance Reason*//*
                int payout_number = jobject.getInt("Payout No");
//String.format("%.2f",jobject.getString("Matching Bonus"));
                final String str1 = jobject.getString("From Date");
                final String str2 = jobject.getString("To Date");
                final String str3 = jobject.getString("Left Brought Forward Business");
                final String str4 = jobject.getString("Right Brought Forward Business");
                final String str5 = jobject.getString("Left New Business");
                final String str6 = jobject.getString("Right New Business");
                final String str7 = jobject.getString("Left Total Business");
                final String str8 = jobject.getString("Right Total Business");
                final String str9 = jobject.getString("Power Side Business");
                final String str10 = jobject.getString("Weaker Side Business");
                final String str11 = jobject.getString("Matched Business");
                final String str12 = jobject.getString("BV Matching Bonus");
                final String str13 = jobject.getString("Gross Incentive");
                final String str14 = jobject.getString("TDS Amount");
                final String str15 = jobject.getString("Previous Balance");
