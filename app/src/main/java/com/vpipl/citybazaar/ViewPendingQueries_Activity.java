...
public class ViewPendingQueries_Activity extends AppCompatActivity {
    ...
    Activity act = ViewPendingQueries_Activity.this;
            ...
            if (AppUtils.isNetworkAvailable(act)) {
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            if (Type.equalsIgnoreCase("Open"))
                                response = AppUtils.callWebServiceWithMultiParam(act, postparameters, QueryUtils.methodToOpenQueriesReport, TAG);
                            else
                                response = AppUtils.callWebServiceWithMultiParam(act, postparameters, QueryUtils.methodToClosedQueriesReport, TAG);
        ...
        for (int i = 0; i < jarray.length(); i++) {
            try {
                ...
                G.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(act, ViewCompleteConversation_Activity.class).putExtra("TicketNo", "" + G.getId()));
                    }
                });
