...
public class Weekly_Incentive_report_Activity extends AppCompatActivity {

    Activity act = Weekly_Incentive_report_Activity.this;
    private String TAG = "Weekly_Incentive_report_Activity";
                ...
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            ...
                            response = AppUtils.callWebServiceWithMultiParam(act, postParameters, QueryUtils.methodWeeklyIncentive, TAG);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        return response;
...
/*Payout No":16,"From Date":"Sep 29 2020 12:01AM","To Date":"Oct  5 2020 12:03AM","BV Matching Bonus":3000.00,"Gross Incentive":3000.00,
...
"Payment Date":"NA","Transaction No.":"0","Remarks":""*/
               ...
               /* final String str10 = jobject.getString("Closing Balance Reason");
                final String str11 = jobject.getString("Pay Status");
