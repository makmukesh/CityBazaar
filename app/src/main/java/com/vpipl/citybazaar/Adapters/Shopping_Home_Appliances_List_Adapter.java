...
public class Shopping_Home_Appliances_List_Adapter extends RecyclerView.Adapter<Shopping_Home_Appliances_List_Adapter.MyViewHolder> {
    public static ArrayList<HashMap<String, String>> achiverList;
    private LayoutInflater inflater = null;
    private Context context;
    private String TAG = "Shopping_Home_Appliances_List_Adapter";

    public Shopping_Home_Appliances_List_Adapter(Context con, ArrayList<HashMap<String, String>> list) {
        achiverList = list;
