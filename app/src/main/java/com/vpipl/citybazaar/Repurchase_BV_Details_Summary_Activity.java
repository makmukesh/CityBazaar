...
public class Repurchase_BV_Details_Summary_Activity extends AppCompatActivity {
    ...
    Activity act = Repurchase_BV_Details_Summary_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Action.equalsIgnoreCase("Team BV Details"))
            txt_heading.setText("Team BV Details");
        else if (Action.equalsIgnoreCase("Self BV Details"))
            txt_heading.setText("Self BV Details");
