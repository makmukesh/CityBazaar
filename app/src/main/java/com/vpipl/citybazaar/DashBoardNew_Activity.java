...
public class DashBoardNew_Activity extends Activity
        implements NavigationView.OnNavigationItemSelectedListener {

    Activity act = DashBoardNew_Activity.this;
    ...
    TextView txt_joining_Date, txt_user_id, txt_Status, txt_ActivationDate, txt_ActivationPoint, txt_LastProfileUpdate;
    ...
    TextView txt_main_heading,txt_member_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
         ...
         /*   this.getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,
           ...
           // toolbar.setNavigationIcon(R.drawable.icon_nav_bar);
...
*/
                ...
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected void onPostExecute(String resultData) {
                        ...
                        try {
                            ...
                            JSONArray jsonArrayMyDownlineTeamStatus = jsonObject.getJSONArray("DownlineTeamStatus");
                            JSONArray jsonArrayMyDirectMemberStatus = jsonObject.getJSONArray("DirectMemberBonus");
                            JSONArray jsonArrayMySponsoringTeamStatus = jsonObject.getJSONArray("MySponsoringTeamStatus");
                            JSONArray jsonArrayCuurentSessionActivationStatuss = jsonObject.getJSONArray("CuurentSessionActivationStatus");
                            JSONArray jsonArrayTotalIncome = jsonObject.getJSONArray("TotalIncome");
                            JSONArray jsonArrayRank = jsonObject.getJSONArray("Rank");

                            if (jsonObject.getString("Status").equalsIgnoreCase("True")) {
                                WriteValues(jsonArrayMyDetails, jsonArrayMyDownlineTeamStatus, jsonArrayMyDirectMemberStatus,
                                        jsonArrayMySponsoringTeamStatus, jsonArrayCuurentSessionActivationStatuss, jsonArrayTotalIncome, jsonArrayRank);
                            } else {
    ...
    private void WriteValues(JSONArray jsonArrayMyDetails, JSONArray jsonArrayMyDownlineTeamStatus, JSONArray jsonArrayMyDirectMemberStatus,
                             JSONArray jsonArrayMySponsoringTeamStatus, JSONArray jsonArrayCuurentSessionActivationStatuss,
                             JSONArray jsonArrayTotalIncome, JSONArray jsonArrayRank) {
...
//txt_Core_Member_Income, txt_Reward_income, txt_Monthly_income
           /* if (jsonArrayMyDetails.length() > 0) {
                txt_matching_bonus.setText("" + jsonArrayMyDetails.getJSONObject(0).getInt("Status"));
                txt_Core_Member_Income.setText("" + jsonArrayMyDetails.getJSONObject(0).getInt("JoiningDt"));
                txt_Reward_income.setText("" + jsonArrayMyDetails.getJSONObject(0).getInt("IdNo"));
                txt_Monthly_income.setText(jsonArrayMyDetails.getJSONObject(0).getString("PayDate"));
            } else {*/
        ...
        expListView.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                ...
                if (GroupTitle.trim().equalsIgnoreCase(getResources().getString(R.string.dashboard))) {
                    startActivity(new Intent(act, DashBoardNew_Activity.class));
                    if (drawer.isDrawerOpen(GravityCompat.START)) {
                        drawer.closeDrawer(GravityCompat.START);
                    }
