...
public class Wallet_Transaction_Report_Activity extends AppCompatActivity {
    ...
    Activity act = Wallet_Transaction_Report_Activity.this;
    private String TAG = "Wallet_Transaction_Report_Activity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            txt_heading.setText("Wallet Transaction Detail");
      ...
      //  row1.addView(H1);
        ...
        for (int i = 0; i < jarray.length(); i++) {
            try {
                ...
                String DeductionDD = jobject.getString("DeductionDD");
