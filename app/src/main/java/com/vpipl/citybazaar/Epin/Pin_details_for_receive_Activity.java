...
public class Pin_details_for_receive_Activity extends AppCompatActivity {

    private static final String TAG = "Pin_details_for_receive_Activity";
        ...
        img_login_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!AppController.getSpIsLogin().getBoolean(SPUtils.IS_LOGIN, false)) {
                    startActivity(new Intent(Pin_details_for_receive_Activity.this, Login_New_Activity.class));
                } else {
                    AppUtils.showDialogSignOut(Pin_details_for_receive_Activity.this);
                }
            }
        });
    }
...
/*        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
    ...
    private void executeRepurchaseBVSummaryDetail() {
        ...
        try {
            if (AppUtils.isNetworkAvailable(Pin_details_for_receive_Activity.this)) {
                new AsyncTask<Void, Void, String>() {
                    protected void onPreExecute() {
                        AppUtils.showProgressDialog(Pin_details_for_receive_Activity.this);
                    }
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            ...
                            response = AppUtils.callWebServiceWithMultiParam(Pin_details_for_receive_Activity.this, postParameters, QueryUtils.methodToPinReceiveReportDetails, TAG);

                        } catch (Exception e) {
                            e.printStackTrace();
                            AppUtils.showExceptionDialog(Pin_details_for_receive_Activity.this);
                        }
                        return response;
                    }
                            ...
                            if (!TextUtils.isEmpty(resultData)) {
                                ...
                                if (jsonObject.getString("Status").equalsIgnoreCase("True")) {
                                    if (jsonObject.getString("Message").equalsIgnoreCase("Successfully.!")) {
                                        ...
                                        AppUtils.alertDialog(Pin_details_for_receive_Activity.this, jsonObject.getString("Message"));
                                    }
                                } else {
                                    AppUtils.alertDialog(Pin_details_for_receive_Activity.this, jsonObject.getString("Message"));
                                }
                            } else {
                                AppUtils.alertDialog(Pin_details_for_receive_Activity.this, "No Data Found");
                            }
