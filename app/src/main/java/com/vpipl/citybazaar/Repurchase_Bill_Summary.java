...
public class Repurchase_Bill_Summary extends AppCompatActivity {
    ...
    Activity act = Repurchase_Bill_Summary.this ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_heading.setText("BV Bill Summary");
...
*/
    ...
    private void createRepurchaseBillSummary() {
        ...
        if (!txt_from_joining.getText().toString().equalsIgnoreCase("")
            ...
            FromDate = AppUtils.getFormatDate1(txt_from_joining.getText().toString());
        }
            ...
            if (AppUtils.isNetworkAvailable(act)) {
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected String doInBackground(Void... params) {
                        String response = "";
                        try {
                            response = AppUtils.callWebServiceWithMultiParam(act, postparameters,
